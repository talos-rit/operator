...
{
    address_idx = AddKey(SOCKET_CONF_BINDING_ADDR_KEY, SOCKET_CONF_BINDING_ADDR_DEFAULT);
...
uint16_t SocketConfig::GetPort()
{
    return GetInt(port_idx);
}
