...
// #define UTIL_TS_ISO6801_MSEC            UTIL_TS_ISO6801 UTIL_TS_MSEC #define
// UTIL_TS_ISO6801_LEN            (UTIL_TS_ISO6801_LEN +      UTIL_TS_MSEC_LEN)
// #define UTIL_TS_ISO6801_USEC            UTIL_TS_ISO6801_MSEC UTIL_TS_MSEC
// #define UTIL_TS_ISO6801_LEN            (UTIL_TS_ISO6801_MSEC_LEN +
// UTIL_TS_MSEC_LEN)

// #define UTIL_DTS_ISO6801_Z               UTIL_DATESTAMP UTIL_TS_ISO6801_Z
// #define UTIL_DTS_ISO6801_Z_LEN          (UTIL_DATESTAMP_LEN +
// UTIL_TS_ISO6801_Z_LEN) #define UTIL_DTS_ISO6801 UTIL_DATESTAMP
// UTIL_TS_ISO6801 #define UTIL_DTS_ISO6801_LEN            (UTIL_DATESTAMP_LEN +
// UTIL_TS_ISO6801_LEN) #define UTIL_DTS_ISO6801_MSEC            UTIL_DATESTAMP
// UTIL_TS_ISO6801_MSEC #define UTIL_DTS_ISO6801_LEN (UTIL_DATESTAMP_LEN +
// UTIL_TS_ISO6801_LEN) #define UTIL_DTS_ISO6801_USEC            UTIL_DATESTAMP
// UTIL_TS_ISO6801_USEC #define UTIL_DTS_ISO6801_LEN (UTIL_DATESTAMP_LEN +
// UTIL_TS_ISO6801_LEN)
...
/**
 * @brief Formats an ISO6801 THH:MM:SSZ timestamp at the string provided
 * (UTC/Zulu time)
 *
 * @param dst_str pointer to string to be formatted
 *
...
/**
 * @brief Formats an ISO6801 THH:MM:SS timestamp at the string provided (local
 * time)
 *
 * @param dst_str pointer to string to be formatted
 *
...
/**
 * @brief Formats the milli- and micro- second portion of a timestamp at the
 * string provided
 *
 * @param dst_str pointer to string to be formatted
 *
 ...
 * @param dst_str pointer to string to be formatted
 *
 * @param tz_offset_sec timezone offset in minutes compared to UTC (a value of
 * zero will result in a "Z", like UTC)
 *
 * @return the length of the formatted string upon success, -1 upon failure
 */
...
/**
 * @brief Formats a complete ISO6801 date-time stamp, with offset
 * (YYYY-MM-DDTHH:MM:SS+TH:TM) at the string provided
 *
 * @param dst_str pointer to string to be formatted
 *
 * @param time time to be stamped
 *
 * @param tz_offset_min timezone offset in minutes compared to UTC (a value of
 * zero will result in a "Z", like UTC)
 *
 * @return the length of the formatted string upon success, -1 upon failure
 */
int8_t UTIL_time_iso8601_complete_datetime(char *dst_str, time_t time,
