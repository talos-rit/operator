 ...
 *      - Adjustable priority thresholds for console and file log outputs on a
 * file-by-file basis
 *      - ISO6801 Timestamps
 ...
 * an application
 * @details Prepares the log resources, so logs can be written whether the Log
 * module has been initialized/started, or not
